...
API_KEY = os.getenv("TTSOPENAI_KEY")
...
def index():
    if request.method == "POST":
        ...
        data = {"model": "tts-1", "voice_id": voice_id, "speed": 1.0, "input": text}
    ...
    <form method="post">
        <textarea name="text" rows="5" cols="50" placeholder="Enter text...">Hello! Walk 20 steps to coffee shop.</textarea><br>
